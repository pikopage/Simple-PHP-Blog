 ...
 $menu .= "<div class='w3-card w3-round ".$card_color." w3-margin-right w3-margin-bottom' style='max-width:570px'>
     ...
     if ($_SESSION['username'] && $_GET['login']!=="no") {
        ...
        $menu = "<a href='index.php?action=3' class='w3-bar-item w3-round w3-btn w3-margin-right w3-margin-bottom ".$bck_color."'> <i class='fa fa-file w3-margin-right'></i>New Post</a>";
    }
        if ($_SESSION['username'] && $_GET['login']!=="no") {
        $menu .= "<a href='cat.php' class='w3-bar-item w3-round w3-btn w3-margin-right w3-margin-bottom ".$bck_color."'><i class='fa fa-list-alt w3-margin-right'></i>Categories</a>";
    }
    if ($_SESSION['username'] && $_GET['login']!=="no") {
        $menu .=  "<a href='index.php?login=no' class='w3-bar-item w3-round w3-btn w3-margin-right w3-margin-bottom ".$bck_color."'><i class='fa fa-sign-out w3-margin-right'></i>Sign out</a>";
    }
}
    ?>
